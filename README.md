...
cd Attentiophages
python3.11 -m unittest discover -t . -s tests   # 121 tests, no dependencies
...
| `tests/` | 121 tests, standard library only |
...
- **[docs/13-moltbook-metrics.md](docs/13-moltbook-metrics.md)** — the v2
